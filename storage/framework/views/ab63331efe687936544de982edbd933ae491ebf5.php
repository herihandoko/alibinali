<div class="bravo-form-search-event <?php if(!empty($style) and $style == "carousel"): ?> bravo-form-search-slider <?php endif; ?>" <?php if(empty($style)): ?> style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('<?php echo e($bg_image_url); ?>') !important" <?php endif; ?>>
...
<?php /**PATH /home/u1568686/public_html/themes/BC/Event/Views/frontend/blocks/form-search-event/index.blade.php ENDPATH**/ ?>