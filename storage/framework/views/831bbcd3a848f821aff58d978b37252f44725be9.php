<form class="bravo-form-login" method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" autocomplete="off" placeholder="<?php echo e(__('Email')); ?>">
    ...
    <div class="form-group">
        <div class="d-flex justify-content-between">
            <label for="remember-me" class="mb0">
                <input type="checkbox" name="remember" id="remember-me" value="1"> <?php echo e(__('Ingat saya')); ?> <span class="checkmark fcheckbox"></span>
            </label>
    ...
    <?php if(is_enable_registration()): ?>
        <div class="c-grey font-medium f14 text-center"> <?php echo e(__('Belum punya akun?')); ?> <a href="" data-target="#register" data-toggle="modal"><?php echo e(__('Daftar')); ?></a></div>
    <?php endif; ?>
</form>
<?php /**PATH /home/u1568686/public_html/modules/Layout/auth/login-form.blade.php ENDPATH**/ ?>