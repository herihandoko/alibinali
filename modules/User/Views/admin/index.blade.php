                            ...
                            <tr>
                                ...
                                <td>{{$row->email}}
                                    @if($row->email_verified_at)
                                        <i class="fa fa-check-circle text-success" title="{{__("Terverifikasi")}}"></i>
                                    @else
                                        <i class="fa fa-info-circle text-warning" title="{{__("Tidak Terverifikasi")}}"></i>
                                    @endif
                                </td>
                                <td>{{$row->balance}}</td>
                                <td>{{$row->phone}}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"  href="{{route('user.admin.detail',['id'=>$row->id])}}"><i class="fa fa-edit"></i> {{__('Ubah')}}</a>
                                            @if(!$row->hasVerifiedEmail())
                                                <a class="dropdown-item"  href="{{route('user.admin.verifyEmail',$row)}}"><i class="fa fa-edit"></i> {{__('Verifikasi EMail')}}</a>
                                                @else
                                                <a class="dropdown-item"  href="#" ><i class="fa fa-check"></i> {{__('Email verified')}}</a>
                                            @endif
                                            <a class="dropdown-item" href="{{route('user.admin.password',['id'=>$row->id])}}"><i class="fa fa-lock"></i> {{__('Ubah Password')}}</a>
