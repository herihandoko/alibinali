...
Route::group(['prefix' => 'user', 'middleware' => ['api'],], function ($router) {
    ...
    Route::get('list-package', 'UserController@listPackage')->name("api.user.list_package");
    Route::get('virtual-account', 'UserController@virtualAccount')->name("api.user.virtual_account");
