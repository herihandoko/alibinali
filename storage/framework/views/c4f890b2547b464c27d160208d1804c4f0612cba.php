...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Permintaan Menjadi Agent")); ?></h1>
        </div>
                ...
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th width="20%"><?php echo e(__('Nama')); ?></th>
                            <th><?php echo e(__('Email')); ?></th>
                            <th><?php echo e(__('Permintaan')); ?></th>
                            <th class="date"><?php echo e(__('Tgl Permintaan')); ?></th>
                            <th class="date"><?php echo e(__('Tgl Disetujui')); ?></th>
                            <th width="15%"><?php echo e(__('Disetujui Oleh')); ?></th>
                            <th width="5%"><?php echo e(__('Status')); ?></th>
                            <th width="15%"><?php echo e(__('Aksi/Kode Referral')); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if($rows->total() > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <?php if($row->status != 'approved'): ?>
                                            <a class="btn btn-sm btn-info approve-user" data-id="<?php echo e($row->id); ?>"  href="<?php echo e(route('user.admin.upgradeId',['id' => $row->id])); ?>"><?php echo e(__('Setuju')); ?></a>
                                        <?php else: ?>
                                            <strong><?php echo e(isset($row->referral->referral_code)?$row->referral->referral_code:'-'); ?></strong>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1568686/public_html/modules/User/Views/admin/upgrade-user.blade.php ENDPATH**/ ?>