                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('name',$dataUser->name)}}" name="name" placeholder="{{__("John Doe")}}" class="form-control form-control-sm" required>
                                        <i class="fa fa-user input-icon"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('father_name',$dataUser->father_name)}}" name="father_name" placeholder="{{__("John Doe")}}" class="form-control form-control-sm" required>
                                        <i class="fa fa-user input-icon"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('no_identitas',$dataUser->no_identitas)}}" name="no_identitas" placeholder="{{__("352152402870002")}}" class="form-control form-control-sm" required>
                                        <i class="fa fa-user input-icon"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{__("Tempat Lahir")}}<span class="text-danger">*</span></label>
                                        <input type="text" value="{{old('birthcity',$dataUser->birthcity)}}" name="birthcity" placeholder="{{__("Jakarta")}}" class="form-control form-control-sm" required>
                                        <i class="fa fa-building input-icon"></i>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('birthday',$dataUser->birthday? display_date($dataUser->birthday) :'') }}" name="birthday" placeholder="" class="form-control form-control-sm date-picker" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{__("Alamat")}}<span class="text-danger">*</span></label>
                                        <input type="text" value="{{old('address',$dataUser->address)}}" name="address" placeholder="{{__("Jl. Jend Sudirman No. 1 Rt.001/002")}}" class="form-control form-control-sm" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('kelurahan',$dataUser->kelurahan)}}" name="kelurahan" placeholder="{{__("Sukabumi Selatan")}}" class="form-control form-control-sm" required>
                                        <i class="fa fa-map input-icon"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('no_telp',$dataUser->no_telp)}}" name="no_telp" placeholder="{{__("08112349870")}}" class="form-control form-control-sm" required>
                                        <i class="fa fa-phone input-icon"></i>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('phone',$dataUser->phone)}}" name="phone" placeholder="{{__("08112349870")}}" class="form-control form-control-sm" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{__("Alamat E-mail Aktif")}} <span class="text-danger">*</span></label>
                                        <input type="text" name="email" value="{{old('email',$dataUser->email)}}" placeholder="{{__("Alamat E-mail Aktif")}}" class="form-control" required>
                                        <i class="fa fa-envelope input-icon"></i>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('nama_paspor',$dataUser->nama_paspor)}}" name="nama_paspor" placeholder="{{__("John Doe")}}" class="form-control form-control-sm">
                                        <i class="fa fa-user input-icon"></i>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('no_paspor',$dataUser->no_paspor)}}" name="no_paspor" placeholder="{{__("1A11A9189-XRS")}}" class="form-control form-control-sm">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('kota_paspor',$dataUser->kota_paspor)}}" name="kota_paspor" placeholder="{{__("Jakarta")}}" class="form-control form-control-sm">
                                        <i class="fa fa-building input-icon"></i>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('tgl_release_paspor',($dataUser->tgl_release_paspor and ($dataUser->tgl_expired_paspor != '0000-00-00')) ? display_date($dataUser->tgl_release_paspor) :'') }}" name="tgl_release_paspor" placeholder="" class="form-control form-control-sm date-picker">
                                        <i class="fa fa-calendar input-icon"></i>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('tgl_expired_paspor',($dataUser->tgl_expired_paspor and ($dataUser->tgl_expired_paspor != '0000-00-00'))? display_date($dataUser->tgl_expired_paspor) :'') }}" name="tgl_expired_paspor" placeholder="" class="form-control form-control-sm date-picker">
                                        <i class="fa fa-calendar input-icon"></i>
                                    </div>
                                </div>
                            </div>
