<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" autocomplete="off" placeholder="{{__('Email')}}">
    ...
    <div class="form-group">
        <div class="d-flex justify-content-between">
            <label for="remember-me" class="mb0">
                <input type="checkbox" name="remember" id="remember-me" value="1"> {{__('Ingat saya')}} <span class="checkmark fcheckbox"></span>
            </label>
    ...
    @if(is_enable_registration())
        <div class="c-grey font-medium f14 text-center"> {{__('Belum punya akun?')}} <a href="" data-target="#register" data-toggle="modal">{{__('Daftar')}}</a></div>
    @endif
</form>
