...
<div class="sidebar-user">
    ...
    <div class="user-profile-avatar">
        <div class="info-new">
            ...
            <p><?php echo e(__("Terdaftar Sejak :time",["time"=> date("d M Y",strtotime($dataUser->created_at))])); ?></p>
        </div>
    </div>
    <div class="user-profile-plan">
        <?php if( !Auth::user()->hasPermission("dashboard_vendor_access") and setting_item('vendor_enable')): ?>
        <a href=" <?php echo e(route("user.upgrade_vendor")); ?>"><?php echo e(__("Jadi Agent")); ?></a>
        <?php else: ?>
        <span class="role-name badge badge-success">
            <?php echo e(__("Kode Referral:")); ?>

        </span>
        <p><?php echo e(isset($dataUser->userReferralCode()->referral_code)?$dataUser->userReferralCode()->referral_code:'-'); ?></p>
        <?php endif; ?>
    </div>
    ...
    <div class="logout">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form-vendor').submit();"><i class="fa fa-sign-out"></i> <?php echo e(__("Keluar")); ?>

        </a>
    </div>
    <div class="logout">
        <a href="<?php echo e(url('/')); ?>" style="color: #1ABC9C"><i class="fa fa-long-arrow-left"></i> <?php echo e(__("Website")); ?></a>
    </div>
</div>
<?php /**PATH /home/u1568686/public_html/themes/Base/User/Views/frontend/layouts/sidebar.blade.php ENDPATH**/ ?>