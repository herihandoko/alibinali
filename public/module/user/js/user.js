...
//    $('#upload-foto').each(function () {
//        var containerFoto = $(this);
        $(document).on('change', '.btn-foto :file', function (event) {
            console.log(event);
        ...
        $('.upload-foto .btn-foto :file').on('bravo-file-update-success', function (event, data) {
            $(".upload-foto input[type=hidden]").attr('value', data.data.id);
            $(".upload-foto .image-foto").attr('src', data.data.sizes.default);
            $(".upload-foto .text-foto").attr('value', data.data.sizes.default);
        });
        $('.upload-foto .btn-foto :file').on('bravo-file-before-update', function () {
            $(".upload-foto .text-foto").attr('value', $(".upload-foto .text-foto").data("loading"));
        });
        $('.upload-foto .btn-foto :file').on('bravo-file-update-error', function (event, message) {
            if (message.length > 0) {
                $(".upload-foto .text-foto").attr('value', message);
            } else {
                $(".upload-foto .text-foto").attr('value', $(".upload-foto .text-foto").data("error"));
            }
        });
//    });

    $(document).on('change', '.btn-ktp :file', function (event) {
        var files = event.target.files;
        var input = $(this);
        var formData = new FormData();
        $.each(files, function (key, value) {
    ...
    $('.upload-ktp .btn-ktp :file').on('bravo-file-update-success', function (event, data) {
        $(".upload-ktp input[type=hidden]").attr('value', data.data.id);
        $(".upload-ktp .image-ktp").attr('src', data.data.sizes.default);
        $(".upload-ktp .text-ktp").attr('value', data.data.sizes.default);
    });
    $('.upload-ktp .btn-ktp :file').on('bravo-file-before-update', function () {
        $(".upload-ktp .text-ktp").attr('value', $(".upload-ktp .text-ktp").data("loading"));
    });
    $('.upload-ktp .btn-ktp :file').on('bravo-file-update-error', function (event, message) {
        if (message.length > 0) {
            $(".upload-ktp .text-ktp").attr('value', message);
        } else {
            $(".upload-ktp .text-ktp").attr('value', $(".upload-ktp .text-ktp").data("error"));
        }
    });
    
    $(document).on('change', '.btn-kk :file', function (event) {
        var files = event.target.files;
        var input = $(this);
        var formData = new FormData();
        $.each(files, function (key, value) {
    ...
    $('.upload-kk .btn-kk :file').on('bravo-file-update-success', function (event, data) {
        $(".upload-kk input[type=hidden]").attr('value', data.data.id);
        $(".upload-kk .image-kk").attr('src', data.data.sizes.default);
        $(".upload-kk .text-kk").attr('value', data.data.sizes.default);
    });
    $('.upload-kk .btn-kk :file').on('bravo-file-before-update', function () {
        $(".upload-kk .text-kk").attr('value', $(".upload-kk .text-kk").data("loading"));
    });
    $('.upload-kk .btn-kk :file').on('bravo-file-update-error', function (event, message) {
        if (message.length > 0) {
            $(".upload-kk .text-kk").attr('value', message);
        } else {
            $(".upload-kk .text-kk").attr('value', $(".upload-kk .text-kk").data("error"));
        }
    });
    
    $(document).on('change', '.btn-paspor :file', function (event) {
        var files = event.target.files;
        var input = $(this);
        var formData = new FormData();
        $.each(files, function (key, value) {
    ...
    $('.upload-paspor .btn-paspor :file').on('bravo-file-update-success', function (event, data) {
        $(".upload-paspor input[type=hidden]").attr('value', data.data.id);
        $(".upload-paspor .image-paspor").attr('src', data.data.sizes.default);
        $(".upload-paspor .text-paspor").attr('value', data.data.sizes.default);
    });
    $('.upload-paspor .btn-paspor :file').on('bravo-file-before-update', function () {
        $(".upload-paspor .text-paspor").attr('value', $(".upload-paspor .text-paspor").data("loading"));
    });
    $('.upload-paspor .btn-paspor :file').on('bravo-file-update-error', function (event, message) {
        if (message.length > 0) {
            $(".upload-paspor .text-paspor").attr('value', message);
        } else {
            $(".upload-paspor .text-paspor").attr('value', $(".upload-paspor .text-paspor").data("error"));
        }
    });
