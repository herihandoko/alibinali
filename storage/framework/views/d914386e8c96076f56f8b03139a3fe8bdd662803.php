<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-title">
                        <strong><?php echo e(__("BTN Virtual Account")); ?></strong>
                    </div>
                    <div class="form-group">
                        <label><?php echo e(__("Virtual Account Name")); ?></label>
                        <input type="text" value="<?php echo e(old('va_name',$dataUser->va_name)); ?>" name="va_name" placeholder="<?php echo e(__("Virtual Account Name")); ?>" class="form-control" <?php if($dataUser->va_status == '2002700'): ?> disabled <?php endif; ?>>
                        <i class="fa fa-user input-icon"></i>
                    </div>
                    <div class="form-group">
                        <label><?php echo e(__("Virtual Account Number")); ?></label>
                        <input type="number" value="<?php echo e(old('va_number',$dataUser->va_number)); ?>" name="va_number" placeholder="<?php echo e(__("96000081380001XXXX")); ?>" class="form-control" <?php if($dataUser->va_status == '2002700'): ?> disabled <?php endif; ?>>
                        <i class="fa fa-user input-icon"></i>
                    </div>
                    <hr>
                    <div class="form-title">
                        <strong><?php echo e(__("Data Pribadi")); ?></strong>
                    </div>
    ...
    <!--                <div class="form-group">
                    ...
                    <hr>
                    <div class="form-title">
                        <strong><?php echo e(__("Data Manifest")); ?></strong>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1568686/public_html/themes/Base/User/Views/frontend/profile.blade.php ENDPATH**/ ?>