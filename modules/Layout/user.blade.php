...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('libs/bootstrap-table/bootstrap-table.css') }}">
...
<body class="user-page {{$body_class ?? ''}} @if(setting_item_with_lang('enable_rtl')) is-rtl @endif">
    ...
    <script src="{{ asset('libs/bootstrap-table/bootstrap-table.js') }}"></script>
    <script src="{{ asset('libs/bootstrap-table/bootstrap-table-id-ID.js') }}"></script>
    @if(!is_demo_mode())
