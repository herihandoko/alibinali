...
use Modules\Tour\Models\CogsPackage;
...
class TourController extends AdminController {
    ...
    public function create(Request $request) {
        ...
        $data = [
            ...
            'cogs_packages' => CogsPackage::select('id', 'nama_makanan')->with('hpp')->get(),
            'breadcrumbs' => [
                [
                    'name' => __('Tours'),
                    'url' => route('tour.admin.index')
    ...
    public function store(Request $request, $id) {
        ...
        if ($request->input('cogs_id')) {
            $row->cogs_id = $request->input('cogs_id');
        }
