...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('libs/bootstrap-table/bootstrap-table.css')); ?>">
...
<body class="user-page <?php echo e($body_class ?? ''); ?> <?php if(setting_item_with_lang('enable_rtl')): ?> is-rtl <?php endif; ?>">
    ...
    <script src="<?php echo e(asset('libs/bootstrap-table/bootstrap-table.js')); ?>"></script>
    <script src="<?php echo e(asset('libs/bootstrap-table/bootstrap-table-id-ID.js')); ?>"></script>
    <?php if(!is_demo_mode()): ?>
...
<?php /**PATH /home/u1568686/public_html/modules/Layout/user.blade.php ENDPATH**/ ?>