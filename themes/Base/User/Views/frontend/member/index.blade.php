    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                <a href="{{ route('user.member.create') }}" class="btn btn-primary">{{ __('Add new user') }}</a>
        ...
        <div class="filter-div d-flex justify-content-between mb-3">
            <div class="col-left">
                @if (!empty($rows))
                    <form method="post" action="{{ route('user.member.bulkEdit') }}" class="filter-form filter-form-left d-flex justify-content-start">
                        {{ csrf_field() }}
            ...
            <div class="col-left">
                <form method="get" class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    <input type="text" name="s" value="{{ Request()->s }}" placeholder="{{ __('Search by name') }}" class="form-control mr-3">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('user.member.detail', ['id' => $row->id]) }}"><i
                                                                ...
                                                                @endif
                                                                <a class="dropdown-item"
                                                                    href="{{ route('user.member.password', ['id' => $row->id]) }}"><i
                                                                        class="fa fa-lock"></i>
