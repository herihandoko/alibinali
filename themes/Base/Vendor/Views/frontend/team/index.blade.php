                            ...
                            <td style="text-align: center;">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{route('vendor.team.edit',['vendorTeam'=>$vendorTeam->member->id])}}">{{__("Ubah")}}</a>
                                        ...
                                        @endif
                                        <a class="dropdown-item" href="{{URL::signedRoute('vendor.team.delete',['vendorTeam'=>$vendorTeam->member->id])}}">{{__("Hapus")}}</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
