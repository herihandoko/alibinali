                            ...
                            <tr>
                                ...
                                <td><?php echo e($row->email); ?>
                                    ...
                                    <?php if($row->email_verified_at): ?>
                                        <i class="fa fa-check-circle text-success" title="<?php echo e(__("Terverifikasi")); ?>"></i>
                                    <?php else: ?>
                                        <i class="fa fa-info-circle text-warning" title="<?php echo e(__("Tidak Terverifikasi")); ?>"></i>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"  href="<?php echo e(route('user.admin.detail',['id'=>$row->id])); ?>"><i class="fa fa-edit"></i> <?php echo e(__('Ubah')); ?></a>
                                            <?php if(!$row->hasVerifiedEmail()): ?>
                                                <a class="dropdown-item"  href="<?php echo e(route('user.admin.verifyEmail',$row)); ?>"><i class="fa fa-edit"></i> <?php echo e(__('Verifikasi EMail')); ?></a>
                                                <?php else: ?>
                                                <a class="dropdown-item"  href="#" ><i class="fa fa-check"></i> <?php echo e(__('Email verified')); ?></a>
                                            <?php endif; ?>
                                            <a class="dropdown-item" href="<?php echo e(route('user.admin.password',['id'=>$row->id])); ?>"><i class="fa fa-lock"></i> <?php echo e(__('Ubah Password')); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1568686/public_html/modules/User/Views/admin/index.blade.php ENDPATH**/ ?>