<?php echo $__env->make('Tour::admin/tour/cogs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<div class="panel">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="tour_price" name="price" class="form-control" value="<?php echo e($row->price); ?>" placeholder="<?php echo e(__("Tour Price")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
...
<?php /**PATH /home/u1568686/public_html/modules/Tour/Views/admin/tour/pricing.blade.php ENDPATH**/ ?>